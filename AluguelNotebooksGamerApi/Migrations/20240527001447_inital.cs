        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WebCam = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValuePerHour = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RentedId = table.Column<Guid>(type: "uuid", nullable: true),
                    Excluded = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Clients_Renteds_RentedId",
                        column: x => x.RentedId,
                        principalTable: "Renteds",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModelConfigurationId = table.Column<Guid>(type: "uuid", nullable: true),
                    RentedId = table.Column<Guid>(type: "uuid", nullable: true),
                    Excluded = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Models_ModelConfigurations_ModelConfigurationId",
                        column: x => x.ModelConfigurationId,
                        principalTable: "ModelConfigurations",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Models_Renteds_RentedId",
                        column: x => x.RentedId,
                        principalTable: "Renteds",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Models_ModelConfigurationId",
                table: "Models",
                column: "ModelConfigurationId");

            migrationBuilder.CreateIndex(
                name: "IX_Models_RentedId",
                table: "Models",
                column: "RentedId");
        }
